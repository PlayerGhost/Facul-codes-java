...
public class Encriptador {
    ...
    public void ConsultarEncript(char letra, int chave){
        if(letra == ' '){
            temp.adicionar(letra, letra);
        }else{
            aux = posicao(letra);
            char x = 0;
            ...
            temp.adicionar(letra, x);
        }
    }
    
    public void ConsultarDecript(char letra, int chave){
        if(letra == ' '){
            temp.adicionar(letra, letra);
        }else{
            aux = posicao(letra);
